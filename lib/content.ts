...
*   **CHRO Path:** The Chief Human Resources Officer is now a direct peer to the CEO and CFO.
  ...
  'business analytics': {
    ...
    metaDesc: 'MBA Business Analytics online. SQL, Power BI, Tableau, A/B testing and business case writing. Salary Rs 6L to 15L. McKinsey, Deloitte, ZS Associates, LatentView hiring. UGC approved.',
    heroHeadline: 'MBA Business Analytics — Turn Business Questions Into Decisions.',
    heroSub: 'Master SQL, Power BI, A/B testing, and KPI design. The skills strategy, operations, and marketing leaders need from their analytics teams.',
    overview: 'Business Analytics trains managers to answer the questions that run organisations: Which customer segment is most profitable? Where is the operations team losing time? Which marketing channel is actually driving revenue? It is the applied, decision-oriented use of data. You build dashboards, frame experiments, size markets, and present findings to leaders who need to act. India\'s consulting, BFSI, and e-commerce sectors hire hundreds of MBA Business Analytics graduates every year for these roles.',
    whyChoose: ['Every business function needs managers who can build a case from structured data: finance, marketing, HR, operations, strategy','Analytics and insights manager roles pay 30 to 40 percent above equivalent non-analytical management positions','Strategy consulting firms at McKinsey, BCG, Bain, and Deloitte recruit MBA graduates specifically for business analytics tracks','The core toolkit transfers across sectors: same SQL and Power BI skills work at an FMCG, a bank, or a startup','Promotion paths are clear: Business Analyst to Analytics Manager to Director to Chief Analytics Officer'],
    skills: [
      'SQL — joins, window functions, CTEs, writing efficient queries against large business datasets',
      'Advanced Excel — financial modelling, pivot tables, Power Query, scenario analysis, sensitivity tables',
      'Power BI — DAX formulas, data models, executive dashboards, scheduled report delivery',
      'Tableau Desktop — chart selection, calculated fields, filters, story points for client presentations',
      'A/B Testing and Experimentation — designing tests, calculating sample size, interpreting p-values, communicating results to stakeholders',
      'KPI Design and Metric Frameworks — choosing the right metric for each business question, building measurement plans',
      'Business Case Writing — structuring a recommendation from raw data through to an executive summary',
      'Stakeholder Communication — translating quantitative findings into plain-language decisions for non-technical audiences',
      'Cohort and Retention Analysis — customer lifetime value, churn curves, repeat purchase rates',
      'Requirements Gathering — interviewing business owners to define the correct analytical question before touching any data',
    ],
    certifications: [
      'Microsoft Power BI Data Analyst Associate (PL-300) — strong employer recognition at consulting and BFSI firms',
      'Tableau Desktop Specialist — validated visualisation credential, valued at analytics consulting firms',
      'Google Data Analytics Professional Certificate — good foundation for SQL and spreadsheet skills',
      'CBAP (Certified Business Analysis Professional) — IIBA credential, premium for senior BA roles',
      'SQL certification (Mode Analytics or HackerRank) — quick proof of query skills for early-career roles',
    ],
    careerBeginner: [
      {title:'Business Analyst',desc:'Gathers requirements from business owners, structures the right question, queries databases, and delivers findings as a written recommendation'},
      {title:'Junior Consultant (Analytics Track)',desc:'Entry role at strategy or analytics consulting firms: runs structured analyses, prepares client decks, and supports engagement delivery'},
      {title:'Reporting and Insights Executive',desc:'Owns weekly and monthly reporting for a business function: builds dashboards, tracks KPIs, and flags anomalies to leadership'},
    ],
    careerMid: [
      {title:'BI Manager',desc:'Owns the business intelligence infrastructure for a function: Power BI workspace, data refresh schedules, and report governance'},
      {title:'Senior Consultant (Analytics)',desc:'Leads client-facing analytics workstreams at McKinsey, BCG, Bain, Deloitte, or ZS Associates; manages junior team members'},
      {title:'Insights and Strategy Manager',desc:'Translates quantitative findings into strategic options for C-suite stakeholders; owns the measurement framework for a business unit'},
    ],
    careerSenior: [
      {title:'Head of Business Intelligence',desc:'Leads BI and reporting across the organisation; defines the KPI taxonomy and governs self-serve reporting'},
      {title:'Principal Consultant (Data and Strategy)',desc:'Senior advisory at Deloitte, KPMG, or PwC; leads practice-level engagements and develops client relationships'},
      {title:'Chief Analytics Officer',desc:'Emerging C-suite role at data-mature organisations; accountable for how the business uses information to make decisions'},
    ],
    projectIdeas: [
      'Customer profitability scorecard for a retail bank: segment customers by revenue, cost-to-serve, and churn risk using SQL',
      'Pricing elasticity study: build a structured report comparing demand response across three price tiers for a hypothetical subscription product',
      'Operational efficiency review: design a Power BI dashboard for a logistics firm with on-time delivery rates, exception counts, and cost-per-shipment',
      'Market sizing exercise: bottom-up estimate for the Indian EdTech sector using publicly available internet penetration and household income data',
      'Go-to-market readiness report: structured competitive landscape summary for a consumer brand entering a new category in South India',
    ],
    resumeTip: 'Every entry on a Business Analytics resume should follow: business question, approach taken, finding, impact on decision. Power BI certification with a linked portfolio improves callback rates. For consulting applications, written communication samples matter as much as technical credentials.',
    topCompanies: [
      'McKinsey and Company','Boston Consulting Group','Bain and Company',
      'Deloitte Analytics','EY Parthenon','KPMG Advisory','PwC Strategy',
      'Accenture Strategy','ZS Associates','LatentView Analytics',
      'Fractal Analytics','Genpact Analytics','Tiger Analytics',
      'HDFC Bank','ICICI Bank','Flipkart Analytics',
    ],
    salaryRange: 'Rs 6L to 15L per annum',
    salaryGrowth: 'Analytics roles at consulting firms start at Rs 7 to 10L for MBA graduates. Senior analytics managers with 5 years earn Rs 12 to 18L. Analytics consulting principals earn Rs 25 to 45L. Business Analytics pays slightly below Data Science at entry level but has a wider range of employer types.',
    faqs: [
      {q:'What is the difference between MBA Business Analytics and MBA Data Science?',a:'Business Analytics trains you to answer business questions with structured data: SQL queries, Power BI dashboards, A/B tests, KPI frameworks, and written recommendations. The output is a decision. Data Science trains you to build predictive systems: writing algorithms, training models, deploying pipelines. The output is a product or a system. If you want a career in consulting, strategy, product management, or BI teams at banks and FMCG companies, Business Analytics is the right track. If you want to work inside a tech or AI company building the tools themselves, look at Data Science instead.'},
      {q:'Do I need Python for MBA Business Analytics?',a:'No, not at the depth required in engineering or Data Science programs. The core toolkit is SQL, Excel, and Power BI or Tableau. Python basics help but are not a requirement for most consulting, BI, or analytics manager roles in India.'},
    ],
  },
...
export const UNIVERSITY_SYLLABUS: Record<string, UniversitySyllabus> = {
  ...
  'guru-kashi-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Guru Kashi University. Industry-relevant curriculum. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Guru Kashi University online MCA, Guru Kashi University MCA fees, Guru Kashi University MCA syllabus, Guru Kashi University MCA admission 2026, Guru Kashi University MCA specialisations, online MCA guru kashi university, Guru Kashi University MCA UGC approved',
  },
...
export const MASTER_SYLLABUS: Record<string, MasterSyllabus> = {
  ...
  'charusat-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Charotar University of Science & Technology. Rs. 150K total. UGC-Entitled Online Degree. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Charotar University of Science & Technology online MCA, Charotar University of Science & Technology MCA fees, Charotar University of Science & Technology MCA syllabus, Charotar University of Science & Technology MCA admission 2026, Charotar University of Science & Technology MCA specialisations, online MCA charotar university of science & technology, Charotar University of Science & Technology MCA UGC approved',
  },
  'dr-babasaheb-ambedkar-open-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Dr. Babasaheb Ambedkar Open University. Rs. 50K total. Highly Affordable Fee Structure. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Dr. Babasaheb Ambedkar Open University online MCA, Dr. Babasaheb Ambedkar Open University MCA fees, Dr. Babasaheb Ambedkar Open University MCA syllabus, Dr. Babasaheb Ambedkar Open University MCA admission 2026, Dr. Babasaheb Ambedkar Open University MCA specialisations, online MCA dr. babasaheb ambedkar open university, Dr. Babasaheb Ambedkar Open University MCA UGC approved',
  },
  'maharishi-markandeshwar-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Maharishi Markandeshwar. Rs. 100K total. UGC-Approved Deemed-to-be University. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Maharishi Markandeshwar online MCA, Maharishi Markandeshwar MCA fees, Maharishi Markandeshwar MCA syllabus, Maharishi Markandeshwar MCA admission 2026, Maharishi Markandeshwar MCA specialisations, online MCA maharishi markandeshwar, Maharishi Markandeshwar MCA UGC approved',
  },
  'university-of-mysore-online||MCA': {
    ...
    metaDesc: 'Online MCA from University of Mysore. UGC-Entitled & NAAC Accredited Government University. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'University of Mysore online MCA, University of Mysore MCA fees, University of Mysore MCA syllabus, University of Mysore MCA admission 2026, University of Mysore MCA specialisations, online MCA university of mysore, University of Mysore MCA UGC approved',
  },
  ...
  'shobhit-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Shobhit Institute of Engineering & Technology. specialisations in Cloud Computing, AI & Machine Learning +3 more. Rs. 70K total. UGC-DEB appr...',
    metaKeywords: 'Shobhit Institute of Engineering & Technology online MCA, Shobhit Institute of Engineering & Technology MCA fees, Shobhit Institute of Engineering & Technology MCA syllabus, Shobhit Institute of Engineering & Technology MCA admission 2026, Shobhit Institute of Engineering & Technology MCA specialisations, online MCA cloud computing, online MCA ai & machine learning, online MCA full stack development, online MCA shobhit institute of engineering & technology, Shobhit Institute of Engineering & Technology MCA UGC approved',
  },
  ...
  'mangalayatan-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Mangalayatan University. Rs. 67K total. UGC-approved and NAAC A+ accredited university. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Mangalayatan University online MCA, Mangalayatan University MCA fees, Mangalayatan University MCA syllabus, Mangalayatan University MCA admission 2026, Mangalayatan University MCA specialisations, online MCA mangalayatan university, Mangalayatan University MCA UGC approved',
  },
  'bharati-vidyapeeth-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Bharati Vidyapeeth. specialisations in Cloud Computing, Data Science +10 more. Rs. 134K total. UGC-Entitled & AICTE Approved Online MCA Progr...',
    metaKeywords: 'Bharati Vidyapeeth online MCA, Bharati Vidyapeeth MCA fees, Bharati Vidyapeeth MCA syllabus, Bharati Vidyapeeth MCA admission 2026, Bharati Vidyapeeth MCA specialisations, online MCA cloud computing, online MCA data science, online MCA linux, online MCA bharati vidyapeeth, Bharati Vidyapeeth MCA UGC approved',
  },
  'kl-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Koneru Lakshmaiah Education Foundation. specialisations in Artificial Intelligence, Data Science +2 more. Rs. 65K total. UGC Entitled. UGC DE...',
    metaKeywords: 'Koneru Lakshmaiah Education Foundation online MCA, Koneru Lakshmaiah Education Foundation MCA fees, Koneru Lakshmaiah Education Foundation MCA syllabus, Koneru Lakshmaiah Education Foundation MCA admission 2026, Koneru Lakshmaiah Education Foundation MCA specialisations, online MCA artificial intelligence, online MCA data science, online MCA cloud technology, online MCA koneru lakshmaiah education foundation, Koneru Lakshmaiah Education Foundation MCA UGC approved',
  },
  'assam-don-bosco-university-online||BBA': {
  ...
  'amity-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Amity University. specialisations in Artificial Intelligence and Machine Learning, Financial Technology and AI +3 more. Rs. 170K total. UGC-e...',
    metaKeywords: 'Amity University online MCA, Amity University MCA fees, Amity University MCA syllabus, Amity University MCA admission 2026, Amity University MCA specialisations, online MCA artificial intelligence and machine learning, online MCA financial technology and ai, online MCA cyber security, online MCA amity university, Amity University MCA UGC approved',
  },
  'amrita-vishwa-vidyapeetham-online||MCA': {
    ...
    metaDesc: 'Online MCA from Amrita Vishwa Vidyapeetham. specialisations in Artificial Intelligence and Machine Learning, Cybersecurity. Rs. 140K total. UGC-entitled and ...',
    metaKeywords: 'Amrita Vishwa Vidyapeetham online MCA, Amrita Vishwa Vidyapeetham MCA fees, Amrita Vishwa Vidyapeetham MCA syllabus, Amrita Vishwa Vidyapeetham MCA admission 2026, Amrita Vishwa Vidyapeetham MCA specialisations, online MCA artificial intelligence and machine learning, online MCA cybersecurity, online MCA amrita vishwa vidyapeetham, Amrita Vishwa Vidyapeetham MCA UGC approved',
  },
  'assam-don-bosco-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Assam Don Bosco University. specialisations in Artificial Intelligence & Machine Learning, Data Science. UGC & AICTE Approved Degree. UGC DEB...',
    metaKeywords: 'Assam Don Bosco University online MCA, Assam Don Bosco University MCA fees, Assam Don Bosco University MCA syllabus, Assam Don Bosco University MCA admission 2026, Assam Don Bosco University MCA specialisations, online MCA artificial intelligence & machine learning, online MCA data science, online MCA assam don bosco university, Assam Don Bosco University MCA UGC approved',
  },
  'bs-abdur-rahman-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from B.S. Abdur Rahman Institute of Science and Technology. Industry-focused curriculum with emphasis on programming and emerging technologies. UG...',
    metaKeywords: 'B.S. Abdur Rahman Institute of Science and Technology online MCA, B.S. Abdur Rahman Institute of Science and Technology MCA fees, B.S. Abdur Rahman Institute of Science and Technology MCA syllabus, B.S. Abdur Rahman Institute of Science and Technology MCA admission 2026, B.S. Abdur Rahman Institute of Science and Technology MCA specialisations, online MCA b.s. abdur rahman institute of science and technology, B.S. Abdur Rahman Institute of Science and Technology MCA UGC approved',
  },
  'centurion-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Centurion University of Technology and Management. Rs. 120K total. Strong foundation in programming. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Centurion University of Technology and Management online MCA, Centurion University of Technology and Management MCA fees, Centurion University of Technology and Management MCA syllabus, Centurion University of Technology and Management MCA admission 2026, Centurion University of Technology and Management MCA specialisations, online MCA centurion university of technology and management, Centurion University of Technology and Management MCA UGC approved',
  },
  'chandigarh-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Chandigarh University. specialisations in Cloud Computing, Full Stack Development +2 more. Rs. 155K total. Industry-aligned curriculum. UGC D...',
    metaKeywords: 'Chandigarh University online MCA, Chandigarh University MCA fees, Chandigarh University MCA syllabus, Chandigarh University MCA admission 2026, Chandigarh University MCA specialisations, online MCA cloud computing, online MCA full stack development, online MCA data analytics, online MCA chandigarh university, Chandigarh University MCA UGC approved',
  },
  'christ-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Christ. Rs. 230K total. AICTE-Approved Online MCA Program. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Christ online MCA, Christ MCA fees, Christ MCA syllabus, Christ MCA admission 2026, Christ MCA specialisations, online MCA christ, Christ MCA UGC approved',
  },
  'datta-meghe-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Datta Meghe Institute of Higher Education and Research. UGC-Approved Deemed-to-be University with NAAC Accreditation. UGC DEB approved. Admis...',
    metaKeywords: 'Datta Meghe Institute of Higher Education and Research online MCA, Datta Meghe Institute of Higher Education and Research MCA fees, Datta Meghe Institute of Higher Education and Research MCA syllabus, Datta Meghe Institute of Higher Education and Research MCA admission 2026, Datta Meghe Institute of Higher Education and Research MCA specialisations, online MCA datta meghe institute of higher education and research, Datta Meghe Institute of Higher Education and Research MCA UGC approved',
  },
  'dayananda-sagar-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Dayananda Sagar University. specialisations in Cloud Computing Technologies, Data Science +13 more. Rs. 130K total. Industry-Aligned Curricul...',
    metaKeywords: 'Dayananda Sagar University online MCA, Dayananda Sagar University MCA fees, Dayananda Sagar University MCA syllabus, Dayananda Sagar University MCA admission 2026, Dayananda Sagar University MCA specialisations, online MCA cloud computing technologies, online MCA data science, online MCA blockchain technologies, online MCA dayananda sagar university, Dayananda Sagar University MCA UGC approved',
  },
  'desh-bhagat-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Desh Bhagat University. specialisations in Cyber Security, AI and Data Science. Rs. 117K total. UGC-approved and NAAC A+ accredited degree. U...',
    metaKeywords: 'Desh Bhagat University online MCA, Desh Bhagat University MCA fees, Desh Bhagat University MCA syllabus, Desh Bhagat University MCA admission 2026, Desh Bhagat University MCA specialisations, online MCA cyber security, online MCA ai and data science, online MCA desh bhagat university, Desh Bhagat University MCA UGC approved',
  },
  'dr-dy-patil-vidyapeeth-online||MCA': {
    ...
    metaDesc: 'Online MCA from Dr. D.Y. Patil Vidyapeeth (Pune). UGC & AICTE Approved Online Degree with NAAC A++ Accreditation. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Dr. D.Y. Patil Vidyapeeth (Pune) online MCA, Dr. D.Y. Patil Vidyapeeth (Pune) MCA fees, Dr. D.Y. Patil Vidyapeeth (Pune) MCA syllabus, Dr. D.Y. Patil Vidyapeeth (Pune) MCA admission 2026, Dr. D.Y. Patil Vidyapeeth (Pune) MCA specialisations, online MCA dr. d.y. patil vidyapeeth (pune), Dr. D.Y. Patil Vidyapeeth (Pune) MCA UGC approved',
  },
  'gla-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from G.L.A. University. Rs. 86K total. UGC-entitled and NAAC A+ accredited program. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'G.L.A. University online MCA, G.L.A. University MCA fees, G.L.A. University MCA syllabus, G.L.A. University MCA admission 2026, G.L.A. University MCA specialisations, online MCA g.l.a. university, G.L.A. University MCA UGC approved',
  },
  'galgotias-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Galgotias University. Rs. 84K total. UGC-DEB and AICTE approved online degree. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Galgotias University online MCA, Galgotias University MCA fees, Galgotias University MCA syllabus, Galgotias University MCA admission 2026, Galgotias University MCA specialisations, online MCA galgotias university, Galgotias University MCA UGC approved',
  },
  'guru-nanak-dev-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Guru Nanak Dev University. UGC-approved online degree. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Guru Nanak Dev University online MCA, Guru Nanak Dev University MCA fees, Guru Nanak Dev University MCA syllabus, Guru Nanak Dev University MCA admission 2026, Guru Nanak Dev University MCA specialisations, online MCA guru nanak dev university, Guru Nanak Dev University MCA UGC approved',
  },
  'hindustan-institute-technology-online||MCA': {
    ...
    metaDesc: 'Online MCA from Hindustan Institute of Technology and Science (HITS). specialisations in Computer Science and IT, Cyber Security & Cloud Computing +1 more. R...',
    metaKeywords: 'Hindustan Institute of Technology and Science (HITS) online MCA, Hindustan Institute of Technology and Science (HITS) MCA fees, Hindustan Institute of Technology and Science (HITS) MCA syllabus, Hindustan Institute of Technology and Science (HITS) MCA admission 2026, Hindustan Institute of Technology and Science (HITS) MCA specialisations, online MCA computer science and it, online MCA cyber security & cloud computing, online MCA data science, online MCA hindustan institute of technology and science (hits), Hindustan Institute of Technology and Science (HITS) MCA UGC approved',
  },
  'jain-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Jain. specialisations in DevOps, Natural Language Processing & Large Language Models Development +7 more. Rs. 160K total. Dual Qualification ...',
    metaKeywords: 'Jain online MCA, Jain MCA fees, Jain MCA syllabus, Jain MCA admission 2026, Jain MCA specialisations, online MCA devops, online MCA natural language processing & large language models development, online MCA data analytics, online MCA jain, Jain MCA UGC approved',
  },
  'jaipur-national-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Jaipur National University. Rs. 106K total. UGC-approved online degree program. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Jaipur National University online MCA, Jaipur National University MCA fees, Jaipur National University MCA syllabus, Jaipur National University MCA admission 2026, Jaipur National University MCA specialisations, online MCA jaipur national university, Jaipur National University MCA UGC approved',
  },
  'kurukshetra-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Kurukshetra University. UGC-Entitled & NAAC A++ Accredited University. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Kurukshetra University online MCA, Kurukshetra University MCA fees, Kurukshetra University MCA syllabus, Kurukshetra University MCA admission 2026, Kurukshetra University MCA specialisations, online MCA kurukshetra university, Kurukshetra University MCA UGC approved',
  },
  'lovely-professional-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Lovely Professional University. specialisations in AR/ VR (Game Development), Machine Learning & AI +3 more. Industry-oriented curriculum des...',
    metaKeywords: 'Lovely Professional University online MCA, Lovely Professional University MCA fees, Lovely Professional University MCA syllabus, Lovely Professional University MCA admission 2026, Lovely Professional University MCA specialisations, online MCA ar/ vr (game development), online MCA machine learning & ai, online MCA data science, online MCA lovely professional university, Lovely Professional University MCA UGC approved',
  },
  'manav-rachna-online||MCA': {
    ...
    metaDesc: 'Online MCA from Manav Rachna International Institute of Research and Studies. specialisations in Cyber Security and Block Chain, Artificial Intelligence and ...',
    metaKeywords: 'Manav Rachna International Institute of Research and Studies online MCA, Manav Rachna International Institute of Research and Studies MCA fees, Manav Rachna International Institute of Research and Studies MCA syllabus, Manav Rachna International Institute of Research and Studies MCA admission 2026, Manav Rachna International Institute of Research and Studies MCA specialisations, online MCA cyber security and block chain, online MCA artificial intelligence and data science, online MCA cloud computing and internet of things, online MCA manav rachna international institute of research and studies, Manav Rachna International Institute of Research and Studies MCA UGC approved',
  },
  'manipal-academy-higher-education-online||MCA': {
    ...
    metaDesc: 'Online MCA from Manipal Academy of Higher Education. specialisations in Artificial Intelligence & Machine Learning, Cloud Computing +2 more. Rs. 220K total. ...',
    metaKeywords: 'Manipal Academy of Higher Education online MCA, Manipal Academy of Higher Education MCA fees, Manipal Academy of Higher Education MCA syllabus, Manipal Academy of Higher Education MCA admission 2026, Manipal Academy of Higher Education MCA specialisations, online MCA artificial intelligence & machine learning, online MCA cloud computing, online MCA cybersecurity, online MCA manipal academy of higher education, Manipal Academy of Higher Education MCA UGC approved',
  },
  'manipal-university-jaipur-online||MCA': {
    ...
    metaDesc: 'Online MCA from Manipal University Jaipur. specialisations in AI & Data Science, Comprehensive Emerging Technologies +3 more. Rs. 158K total. NAAC A+ Accredi...',
    metaKeywords: 'Manipal University Jaipur online MCA, Manipal University Jaipur MCA fees, Manipal University Jaipur MCA syllabus, Manipal University Jaipur MCA admission 2026, Manipal University Jaipur MCA specialisations, online MCA ai & data science, online MCA comprehensive emerging technologies, online MCA artificial intelligence & machine learning, online MCA manipal university jaipur, Manipal University Jaipur MCA UGC approved',
  },
  'marwadi-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Marwadi University. Rs. 89K total. UGC-Entitled & AICTE-Approved Degree. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Marwadi University online MCA, Marwadi University MCA fees, Marwadi University MCA syllabus, Marwadi University MCA admission 2026, Marwadi University MCA specialisations, online MCA marwadi university, Marwadi University MCA UGC approved',
  },
  'mody-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Mody University of Science and Technology. specialisations in Artificial Intelligence and Machine Learning, Cloud Computing +2 more. Industry...',
    metaKeywords: 'Mody University of Science and Technology online MCA, Mody University of Science and Technology MCA fees, Mody University of Science and Technology MCA syllabus, Mody University of Science and Technology MCA admission 2026, Mody University of Science and Technology MCA specialisations, online MCA artificial intelligence and machine learning, online MCA cloud computing, online MCA internet of things (iot), online MCA mody university of science and technology, Mody University of Science and Technology MCA UGC approved',
  },
  'noida-international-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Noida International University. specialisations in AI & Data Science. Rs. 118K total. UGC-entitled and NAAC A+ accredited degree. UGC DEB app...',
    metaKeywords: 'Noida International University online MCA, Noida International University MCA fees, Noida International University MCA syllabus, Noida International University MCA admission 2026, Noida International University MCA specialisations, online MCA ai & data science, online MCA noida international university, Noida International University MCA UGC approved',
  },
  'srm-institute-science-technology-online||MCA': {
    ...
    metaDesc: 'Online MCA from S.R.M. specialisations in Generative AI. UGC-entitled online degree program. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'S.R.M. online MCA, S.R.M. MCA fees, S.R.M. MCA syllabus, S.R.M. MCA admission 2026, S.R.M. MCA specialisations, online MCA generative ai, online MCA s.r.m., S.R.M. MCA UGC approved',
  },
  'savitribai-phule-pune-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Savitribai Phule Pune University. Rs. 158K total. UGC-Recognized Government University with Strong Academic Legacy. UGC DEB approved. Admissi...',
    metaKeywords: 'Savitribai Phule Pune University online MCA, Savitribai Phule Pune University MCA fees, Savitribai Phule Pune University MCA syllabus, Savitribai Phule Pune University MCA admission 2026, Savitribai Phule Pune University MCA specialisations, online MCA savitribai phule pune university, Savitribai Phule Pune University MCA UGC approved',
  },
  'shanmugha-arts-science-technology-research-online||MCA': {
    ...
    metaDesc: 'Online MCA from Shanmugha Arts, Science, Technology & Research Academy. specialisations in Full Stack Development, Artificial Intelligence & Data Science +1 ...',
    metaKeywords: 'Shanmugha Arts, Science, Technology & Research Academy online MCA, Shanmugha Arts, Science, Technology & Research Academy MCA fees, Shanmugha Arts, Science, Technology & Research Academy MCA syllabus, Shanmugha Arts, Science, Technology & Research Academy MCA admission 2026, Shanmugha Arts, Science, Technology & Research Academy MCA specialisations, online MCA full stack development, online MCA artificial intelligence & data science, online MCA cyber security, online MCA shanmugha arts, science, technology & research academy, Shanmugha Arts, Science, Technology & Research Academy MCA UGC approved',
  },
  'sharda-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Sharda University. specialisations in Data Science, Computer Science and Information Technology +1 more. Rs. 120K total. UGC-recognized and g...',
    metaKeywords: 'Sharda University online MCA, Sharda University MCA fees, Sharda University MCA syllabus, Sharda University MCA admission 2026, Sharda University MCA specialisations, online MCA data science, online MCA computer science and information technology, online MCA augmented reality and virtual reality with artificial intelligence, online MCA sharda university, Sharda University MCA UGC approved',
  },
  'shoolini-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Shoolini University of Biotechnology and Management Sciences. specialisations in AI Specialization, Data Science +1 more. UGC-Entitled Online...',
    metaKeywords: 'Shoolini University of Biotechnology and Management Sciences online MCA, Shoolini University of Biotechnology and Management Sciences MCA fees, Shoolini University of Biotechnology and Management Sciences MCA syllabus, Shoolini University of Biotechnology and Management Sciences MCA admission 2026, Shoolini University of Biotechnology and Management Sciences MCA specialisations, online MCA ai specialization, online MCA data science, online MCA full stack, online MCA shoolini university of biotechnology and management sciences, Shoolini University of Biotechnology and Management Sciences MCA UGC approved',
  },
  ...
  'shri-ramasamy-memorial-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Shri Ramasamy Memorial University. specialisations in Data Science and Machine Learning, Cyber Security & Cyber Forensics +1 more. Rs. 100K t...',
    metaKeywords: 'Shri Ramasamy Memorial University online MCA, Shri Ramasamy Memorial University MCA fees, Shri Ramasamy Memorial University MCA syllabus, Shri Ramasamy Memorial University MCA admission 2026, Shri Ramasamy Memorial University MCA specialisations, online MCA data science and machine learning, online MCA cyber security & cyber forensics, online MCA artificial intelligence & gen ai, online MCA shri ramasamy memorial university, Shri Ramasamy Memorial University MCA UGC approved',
  },
  'sikkim-manipal-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Sikkim Manipal University. Rs. 110K total. UGC-Entitled & NAAC A+ Accredited University. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Sikkim Manipal University online MCA, Sikkim Manipal University MCA fees, Sikkim Manipal University MCA syllabus, Sikkim Manipal University MCA admission 2026, Sikkim Manipal University MCA specialisations, online MCA sikkim manipal university, Sikkim Manipal University MCA UGC approved',
  },
  'upes-online||MCA': {
    ...
    metaDesc: 'Online MCA from University of Petroleum and Energy. specialisations in Artificial Intelligence and Machine Learning, Cyber Security and Forensics +1 more. 2-...',
    metaKeywords: 'University of Petroleum and Energy online MCA, University of Petroleum and Energy MCA fees, University of Petroleum and Energy MCA syllabus, University of Petroleum and Energy MCA admission 2026, University of Petroleum and Energy MCA specialisations, online MCA artificial intelligence and machine learning, online MCA cyber security and forensics, online MCA data science, online MCA university of petroleum and energy, University of Petroleum and Energy MCA UGC approved',
  },
  'uttaranchal-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Uttaranchal University. Rs. 120K total. UGC-entitled and NAAC A+ accredited degree. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Uttaranchal University online MCA, Uttaranchal University MCA fees, Uttaranchal University MCA syllabus, Uttaranchal University MCA admission 2026, Uttaranchal University MCA specialisations, online MCA uttaranchal university, Uttaranchal University MCA UGC approved',
  },
  'vit-vellore-online||MCA': {
    ...
    metaDesc: 'Online MCA from Vellore Institute of Technology. specialisations in Artificial Intelligence, Machine Learning +9 more. Rs. 160K total. UGC-entitled and AICTE...',
    metaKeywords: 'Vellore Institute of Technology online MCA, Vellore Institute of Technology MCA fees, Vellore Institute of Technology MCA syllabus, Vellore Institute of Technology MCA admission 2026, Vellore Institute of Technology MCA specialisations, online MCA artificial intelligence, online MCA machine learning, online MCA cyber security, online MCA vellore institute of technology, Vellore Institute of Technology MCA UGC approved',
  },
  'vignan-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Vignan\'s. specialisations in Computer Science and IT, Data Science. Rs. 90K total. Strong Foundation in Computer Science & IT. UGC DEB approv...',
    metaKeywords: 'Vignan\'s online MCA, Vignan\'s MCA fees, Vignan\'s MCA syllabus, Vignan\'s MCA admission 2026, Vignan\'s MCA specialisations, online MCA computer science and it, online MCA data science, online MCA vignan\'s, Vignan\'s MCA UGC approved',
  },
  'vtu-online||MCA': {
    ...
    metaDesc: 'Online MCA from Visveswaraya Technological University. specialisations in Artificial Intelligence & Data Science, Cyber Security & Cloud Computing. UGC-Appro...',
    metaKeywords: 'Visveswaraya Technological University online MCA, Visveswaraya Technological University MCA fees, Visveswaraya Technological University MCA syllabus, Visveswaraya Technological University MCA admission 2026, Visveswaraya Technological University MCA specialisations, online MCA artificial intelligence & data science, online MCA cyber security & cloud computing, online MCA visveswaraya technological university, Visveswaraya Technological University MCA UGC approved',
  },
  'vivekananda-global-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Vivekananda Global University. specialisations in Artificial Intelligence, Cloud Technology & Information Security. Rs. 150K total. UGC-appro...',
    metaKeywords: 'Vivekananda Global University online MCA, Vivekananda Global University MCA fees, Vivekananda Global University MCA syllabus, Vivekananda Global University MCA admission 2026, Vivekananda Global University MCA specialisations, online MCA artificial intelligence, online MCA cloud technology & information security, online MCA vivekananda global university, Vivekananda Global University MCA UGC approved',
  },
  'yenepoya-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Yenepoya University. specialisations in Computer Science and Information Technology, Cloud Computing and Cyber Security. Rs. 50K total. UGC-E...',
    metaKeywords: 'Yenepoya University online MCA, Yenepoya University MCA fees, Yenepoya University MCA syllabus, Yenepoya University MCA admission 2026, Yenepoya University MCA specialisations, online MCA computer science and information technology, online MCA cloud computing and cyber security, online MCA yenepoya university, Yenepoya University MCA UGC approved',
  },
  ...
  'chhatrapati-shahu-ji-maharaj-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Chatrapati Shahuji Maharaj University. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Chatrapati Shahuji Maharaj University online MCA, Chatrapati Shahuji Maharaj University MCA fees, Chatrapati Shahuji Maharaj University MCA syllabus, Chatrapati Shahuji Maharaj University MCA admission 2026, Chatrapati Shahuji Maharaj University MCA specialisations, online MCA chatrapati shahuji maharaj university, Chatrapati Shahuji Maharaj University MCA UGC approved',
  },
  ...
  'ganpat-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Ganpat university. Rs. 97K total. UGC-Entitled Online Degree. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Ganpat university online MCA, Ganpat university MCA fees, Ganpat university MCA syllabus, Ganpat university MCA admission 2026, Ganpat university MCA specialisations, online MCA ganpat university, Ganpat university MCA UGC approved',
  },
  ...
  'graphic-era-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Graphic Era University. Rs. 35K total. UGC-approved online MCA program. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Graphic Era University online MCA, Graphic Era University MCA fees, Graphic Era University MCA syllabus, Graphic Era University MCA admission 2026, Graphic Era University MCA specialisations, online MCA graphic era university, Graphic Era University MCA UGC approved',
  },
  ...
  'guru-ghasidas-vishwavidyalaya-online||MCA': {
    ...
    metaDesc: 'Online MCA from Guru Ghasidas Vishwavidyalaya. Rs. 127K total. UGC-DEB Entitled Central University. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Guru Ghasidas Vishwavidyalaya online MCA, Guru Ghasidas Vishwavidyalaya MCA fees, Guru Ghasidas Vishwavidyalaya MCA syllabus, Guru Ghasidas Vishwavidyalaya MCA admission 2026, Guru Ghasidas Vishwavidyalaya MCA specialisations, online MCA guru ghasidas vishwavidyalaya, Guru Ghasidas Vishwavidyalaya MCA UGC approved',
  },
  ...
  'jamia-hamdard-online||MCA': {
    ...
    metaDesc: 'Online MCA from Jamia Hamdard. Rs. 87K total. UGC-Approved & NAAC A++ Accredited University. UGC DEB approved. Admission open 2026.',
    metaKeywords: 'Jamia Hamdard online MCA, Jamia Hamdard MCA fees, Jamia Hamdard MCA syllabus, Jamia Hamdard MCA admission 2026, Jamia Hamdard MCA specialisations, online MCA jamia hamdard, Jamia Hamdard MCA UGC approved',
  },
  ...
  'mats-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from MATS University. Comprehensive IT Curriculum (Programming, AI, Cloud, Data Analytics). UGC DEB approved. Admission open 2026.',
    metaKeywords: 'MATS University online MCA, MATS University MCA fees, MATS University MCA syllabus, MATS University MCA admission 2026, MATS University MCA specialisations, online MCA mats university, MATS University MCA UGC approved',
  },
  ...
  'parul-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Parul University. specialisations in Cybersecurity & Forensic, Full Stack Web Development +1 more. Rs. 30K total. NAAC A++ Accredited Univers...',
    metaKeywords: 'Parul University online MCA, Parul University MCA fees, Parul University MCA syllabus, Parul University MCA admission 2026, Parul University MCA specialisations, online MCA cybersecurity & forensic, online MCA full stack web development, online MCA artificial intelligence / machine learning, online MCA parul university, Parul University MCA UGC approved',
  },
  'assam-down-town-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Assam Down Town University. specialisations in Artificial Intelligence & Machine Learning, Data Science. Rs. 90K total. UGC-DEB Approved & NA...',
    metaKeywords: 'Assam Down Town University online MCA, Assam Down Town University MCA fees, Assam Down Town University MCA syllabus, Assam Down Town University MCA admission 2026, Assam Down Town University MCA specialisations, online MCA artificial intelligence & machine learning, online MCA data science, online MCA assam down town university, Assam Down Town University MCA UGC approved',
  },
...
export const UNIVERSITY_LOGOS: Record<string, string> = {
  ...
  'vtu-online': '/logos/university_logos/visvesvaraya-tchnological-university.webp',
  ...
  'maharishi-markandeshwar-university-online': '/logos/university_logos/maharishi-markandeshwar.webp',
  'dr-mgr-educational-research-institute-online': '/logos/university_logos/dr-mgr-logo.svg',
  'sgt-university-online': '/logos/university_logos/sgt.webp',
  ...
  'christ-university-online': '/logos/university_logos/christ-deemed-to-be-university.png',
  'shobhit-university-online': '/logos/university_logos/shobhit-university-logo.svg',
  'bharati-vidyapeeth-university-online': '/logos/university_logos/bharati-vidyapeeth.webp',
  ...
  'guru-nanak-dev-university-online': '/logos/university_logos/guru-nanak-dev-logo.png',
  'gls-university-online': '/logos/university_logos/gujrat-law-socitey.svg',
  'gla-university-online': '/logos/university_logos/gla-mathura-online-logo.webp',
