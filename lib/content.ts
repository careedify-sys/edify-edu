...
export const MASTER_SYLLABUS: Record<string, MasterSyllabus> = {
  ...
  'dayananda-sagar-university-online||MCA': {
    ...
    metaDesc: 'Online MCA from Dayananda Sagar University. specialisations in Cloud Computing Technologies, Data Science +13 more. Rs. 120K total. Industry-Aligned Curricul...',
