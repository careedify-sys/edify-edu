...
const UNIVERSITIES_RAW: (Omit<University, 'highlight'>)[] = [
  ...
  },
  {
    ...
    eligibilityPct: 0,
    tagline: 'Uttar Pradesh state university, UGC-DEB entitled for 12 online programmes',
    description: 'Choudhary Charan Singh University is a state university in Uttar Pradesh listed in the UGC Distance Education Bureau recognition list of August 2026, which grants it 12 programmes for online delivery. Fees for the current intake are not published on this page yet. Confirm entitlement for your admission year and programme at deb.ugc.ac.in before you enrol.',
    forWho: ['Working professionals in Uttar Pradesh wanting a state-university degree', 'Candidates targeting government roles that require a UGC-entitled degree', 'Students who want a wide choice of MA subjects online'],
    ...
    programDetails: {
      'MBA': {
        specs: ['General', 'Hospital Administration'],
        fees: 'Not published',
        duration: '2 Years',
        roles: ['Business Manager', 'Operations Executive', 'Hospital Administrator', 'Business Analyst'],
        avgSalary: '',
        topCompanies: [],
        internshipType: 'Not published',
        careerOutcome: 'UGC-DEB entitled MBA from a Uttar Pradesh state university. The August 2026 UGC list grants both a general MBA and an MBA in Hospital Administration.',
      },
      'MCA': {
        specs: ['General'],
        fees: 'Not published',
      ...
      'BA': {
        ...
        topCompanies: [],
        internshipType: 'Not published',
        careerOutcome: 'UGC-DEB entitled BA offered across the thirteen subject combinations named in the August 2026 UGC grant.',
      },
      'M.Com': {
        specs: ['General'],
        fees: 'Not published',
        ...
        topCompanies: [],
        internshipType: 'Not published',
        careerOutcome: 'UGC-DEB entitled M.Com from a Uttar Pradesh state university, valid for commerce and finance roles and for NET eligibility.',
      },
      'MA': {
