...
export const UNIVERSITIES: University[] = [
  ...
  },
  {
    ...
    naac: 'IoE',
    ugc: true,
    approvals: ['UGC Recognised', 'Institution of Eminence (MoE)', 'AACSB Accredited', 'QS 5 Star'],
    examMode: 'Online',
    govtRecognised: true,
    psuEligible: true,
    feeMin: 0,
    ...
    eligibility: 'Graduation with 50% marks from recognized university',
    eligibilityPct: 50,
    highlight: 'Institution of Eminence · AACSB Accredited · 1-Year MBA',
    tagline: 'India\'s only 1-Year fully online UGC Recognised MBA with AACSB accreditation from an Institution of Eminence',
