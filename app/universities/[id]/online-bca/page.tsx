// app/universities/[id]/online-bca/page.tsx
...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${u.name} BCA - Fees, Specializations, Placements ${year}`,
    ...
    alternates: { canonical: `https://edifyedu.in/universities/${u.id}/online-bca` },
  }
}
    ...
    <div className="page-shell">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {specs.map(spec => (
            <Link key={spec} href={`/universities/${u.id}/online-bca/${makeSlug(spec)}`}
