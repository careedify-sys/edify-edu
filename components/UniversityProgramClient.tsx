...
function FullPage({ u, program, programSlug, pd }: {
  ...
  const faqs = [
    ...
    { q: `What is the total fee for ${program} at ${u.name}?`, a: `Total fee is ${pd.fees || `₹${Math.round(u.feeMin/1000)}K+`}. EMI from ₹${u.emiFrom.toLocaleString()}/month. Semester-wise payment available. Ask an advisor for current scholarships.` },
