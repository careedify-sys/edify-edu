...
/* ─── Well-known universities shown in mega menu ────────────────────────────
   Familiarity bias — people convert faster when they recognise brand names.
                  ...
                  <div
                    ...
                    <div style={{ display: 'flex' }}>
                      ...
                      <div style={{ flex: 1, padding: '16px', minWidth: 0 }}>
                        ...
                        {/* Well-known universities — no ranking or premium label */}
        ...
        {mobileOpen && (
          <div className="lg:hidden"
            ...
            <div style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
              ...
              {/* Well-known universities — mobile */}
