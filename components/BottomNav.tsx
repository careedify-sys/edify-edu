...
import { Home, Search, BarChart2, BookOpen, Phone } from 'lucide-react'
  ...
  return (
    <nav
      ...
      style={{
        ...
        boxShadow: '0 -4px 20px rgba(11,29,53,0.08)',
        display: 'flex',
      }}>
      {TABS.map(tab => {
        ...
        return (
          <Link key={tab.href} href={tab.href}
            ...
            <Icon style={{ width: '20px', height: '20px' }} strokeWidth={active ? 2.5 : 1.8} />
      ...
      <a href="tel:+917061285806"
        style={{
          flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center',
          justifyContent: 'center', gap: '3px', padding: '10px 4px 8px',
          textDecoration: 'none', color: 'var(--sage)',
        }}>
